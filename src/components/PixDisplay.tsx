  ...
  return (
    <div className="flex h-full flex-col">
      <div className="border-b border-border px-5 py-4">
        <h2 className="font-display text-xl font-semibold text-foreground">Pague com PIX</h2>
      ...
      <div className="flex flex-1 flex-col items-center justify-start gap-5 overflow-y-auto px-5 py-6">
        {expired ? (
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <button
              onClick={onClose}
              className="mt-2 rounded-xl bg-foreground px-5 py-2.5 text-sm font-semibold text-background transition hover:bg-gold-soft"
            >
              Fechar
            </button>
          </div>
          ...
          <>
            ...
            {qrCodeBase64 && (
              <img
                ...
                alt="QR Code PIX"
                className="h-52 w-52 rounded-xl border border-border shadow-sm"
              />
            )}

            <div className="w-full">
              <p className="mb-1 text-xs font-semibold uppercase tracking-widest text-muted">Código PIX copia e cola</p>
              <div className="flex items-center gap-2 rounded-lg border border-border bg-background p-3">
                <p className="flex-1 truncate text-xs text-foreground">{qrCode}</p>
                <button
                  onClick={handleCopy}
                  className="shrink-0 rounded-full border border-border px-3 py-1 text-xs font-semibold text-muted transition hover:border-foreground hover:text-foreground"
                >
            ...
            <div className="w-full rounded-xl border border-border bg-background p-4 text-sm text-muted">
